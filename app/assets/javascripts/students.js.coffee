  ...
  $("#new").click ->
    if saved
      ...
      $("tbody").append("<tr>")
        ...
        .append('<td><input id="student_projectscore" name="student[projectscore]" type="number" data-score-field /></td>')
        .append('<td><input id="student_finalscore" name="student[finalscore]" type="number" data-score-field /></td>')
        .append('<td><input id="student_labscore" name="student[labscore]" type="number" data-score-field /></td>')
        .append('<td><input id="student_classscore" name="student[classscore]" type="number" data-score-field /></td>')
